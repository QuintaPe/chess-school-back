...
### ROLES & PERMISSIONS
- **ROLES**: `id`, `name` (Admin, Teacher, Student), role_type (admin, membership).
...
1. **Permisos Estáticos**: Definidos en `USER_ROLES`. Orientados a la gestión del staff (Admin, Teacher).
